            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex justify-between items-center mb-6">
                    <Button
                        onClick={() => router.push('/')}
                        variant="outline"
                        className="bg-card hover:bg-secondary text-primary-foreground border-border text-sm"
                    >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
                    <div className="lg:col-span-8 flex flex-col items-center">
                        ...
                        <div className="relative p-2 md:p-4 bg-gradient-to-b from-border/10 to-transparent rounded-xl border border-border/20 shadow-2xl">
                            <ChessGameBoard />
                        </div>
